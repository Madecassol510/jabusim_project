...
public interface ReceiptMapper {
	...
	List<LicenseBean> searchLicenseName(@Param("searchInput") String searchInput, @Param("licenseType") String licenseType);
	...
	List<LicenseBean> optionLicenseName(@Param("major") String major, @Param("minor") String minor, @Param("licenseType") String licenseType);
	...
	List<ExamPlaceBean> selectRegion(@Param("selectRegion") String region);
