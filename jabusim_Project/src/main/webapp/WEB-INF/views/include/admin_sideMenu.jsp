	...
	<ul class="nav nav-pills flex-column mb-auto" style="padding-top: 30%">
		<li><a href="${root}adminPage/memberManage"
			class="nav-link text-black"> <svg class="bi me-2" width="16"
					height="16">
					<use xlink:href="#speedometer2"></use></svg> 회원관리
		</a></li>
		<li><a href="${root}adminPage/inquiryManage/eduInquiryManage"
			class="nav-link text-black"> <svg class="bi me-2" width="16"
					height="16">
					<use xlink:href="#table"></use></svg> 문의관리
		</a></li>
		<li><a href="${root}adminPage/licenseManage"
			class="nav-link text-black"> <svg class="bi me-2" width="16"
					height="16">
					<use xlink:href="#grid"></use></svg> 자격증관리
		</a></li>
		<li><a href="${root}adminPage/examManage/examManage"
			class="nav-link text-black"> <svg class="bi me-2" width="16"
					height="16">
					<use xlink:href="#people-circle"></use></svg> 시험관리
		</a></li>
	</ul>
	<hr>
